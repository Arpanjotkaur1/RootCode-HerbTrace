...
// deterministic mock result. This lets the harvester capture UI (Saanvi)
// build and test the full confirm/submit flow today without waiting on the
// trained model. Swap MODEL_READY to true once public/models/model.json
// (and metadata.json, weights.bin) exist.
